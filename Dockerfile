...
RUN apt-get update && apt-get install -y php5-pgsql php5-gd php5-xsl git

WORKDIR /var/www/html
RUN git clone http://publico:.publico@git.correlibre.org/publico/orfeo4.5 orfeo && \
...
RUN mkdir ./orfeo/bodega && chown -R www-data ./orfeo/bodega
VOLUME "./orfeo/bodega"
